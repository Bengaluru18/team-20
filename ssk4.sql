...
CREATE TABLE `comment` (
  ...
  PRIMARY KEY (`pid`),
  CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`pid`) REFERENCES `patient` (`pid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `comment` VALUES ('20170404',''),('20170409',''),('20170476',''),('20180202','');
...
-- Dump completed on 2018-07-08  1:16:36
